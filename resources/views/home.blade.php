...
<html lang="en">
    ...
    <body>
        ...
        <div class="text-center container border border-dark mt-5 bg-secondary pt-5 pb-5 pl-5 pr-5 rounded-4">
            ...
            if($ramenonder['onoff'] === 'off') { ?> <img src="{{ asset('img/raamopen.jpg') }}" width="45%" height="250" class="Raam open"> <?php } else { ?> <img src="{{ asset('img/ramendicht.jpg') }}" width="45%" height="250" class="Raam dicht"> <?php } if($ramenboven['onoff'] == 'off') { ?> <img src="{{ asset('img/raamopen.jpg') }}" width="45%" height="250" class="Raam open"> <?php } else { ?> <img src="{{ asset('img/ramendicht.jpg') }}" width="45%" height="250" class="Raam dicht"> <?php }?>
            </div>
            <br>
