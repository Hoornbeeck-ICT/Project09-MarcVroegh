...
<html lang="en">
    ...
    <body>
        ...
        <div class="text-center container border border-dark mt-5 bg-secondary pt-5 pb-5 pl-5 pr-5 rounded-4">
            ...
            <?php $__currentLoopData = $rookmeldinggetall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rookmelding): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
            <td><?php echo e($rookmelding->waar); ?></td>
            <td><?php echo e($rookmelding->wat); ?></td>
            <td><?php echo e($rookmelding->create_at); ?></td>
            </tr>
        ...
        </div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Project09-2022/project2/project/resources/views/rookmelding.blade.php ENDPATH**/ ?>